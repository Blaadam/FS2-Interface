...
function LoadBar()
	...
	local Tween = TweenService:Create(
		LoadingBar:WaitForChild("Subbar"),
		Library.LoadingScreenInfo.TweenData.LoadingTween,
	...
	TweenService
		:Create(
			LoadingBar,
			Library.LoadingScreenInfo.TweenData.ClearScreenTween,
			{ Position = UDim2.new(0.5, 0, 1.1, 0) }
		)
		:Play()
	TweenService:Create(
		LoadingScreen.PercentageText,
		Library.LoadingScreenInfo.TweenData.ClearScreenTween,
		{ Position = UDim2.new(0.5, 0, 1.1, 0) }
	):Play()
	TweenService:Create(
		LoadingScreen.GameTips,
		Library.LoadingScreenInfo.TweenData.ClearScreenTween,
		{ Position = UDim2.new(0.5, 0, 1.1, 0) }
	):Play()
	...
	TweenService:Create(
		LoadingScreen,
		Library.LoadingScreenInfo.TweenData.WholeScreenClear,
	...
	TweenService
		:Create(GamesPage, Library.LoadingScreenInfo.TweenData.LoadGamesPage, { Position = UDim2.new(0.5, 0, 0.5, 0) })
		:Play()
end
